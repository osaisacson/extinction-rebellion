              ...
              <Card.Body>
                <Accordion>
                  ...
                  <form action="/" method="post">
                    ...
                    <br></br>
                    <h6>
                      Representative to send the demand to once it has been
                      defined and accepted by the group. This should be the
                      person who has the authority to raise this issue in
                    ...
                    <div className="list-group-item">
                      ...
                      />
                      <span>
                        Create a new account on Twitter called @xr110references,
                        after this initial setup you will not need to touch it
                        again.
                      </span>
                    </div>
                    <div className="list-group-item">
                    ...
                    <div className="list-group-item">
                      ...
                      <span>
                        ...
                        IFTTT{" "}
                        <a href="https://ifttt.com/applets/SMvaxczG-if-hashtag-then-retweet-it">
                          recipe.
                        </a>
                      </span>
                    </div>
                    <p>
                      ...
                      petition. You don't have to do anything.
                    </p>
                  </form>
                  <br></br>
